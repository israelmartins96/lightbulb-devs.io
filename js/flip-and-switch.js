var flipAndSwitch = ()=>{
	var flipCard = (()=>{
			const flipCards = { //
				card: document.querySelectorAll('.flip-cards .flip-card'),
				front: document.querySelectorAll('.flip-cards .flip-card .front'),
				back: document.querySelectorAll('.flip-cards .flip-card .back')
			};
			//
			var flippedCardOne = ()=>{
	...
	var pricesSwitch = (()=>{
		var switchTabs = (()=>{
			const pricing = {
				mainTab: document.querySelectorAll('.tab-switcher .main-tab'), //
				subTab: { //
				...
				category: document.querySelectorAll('.categories .category'),
				subcategory: { //
				...
				requestButton: document.querySelectorAll('.categories .plan .request-button')
			};
			var showDetails = [false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false];
			var resetPlanDetailsDisplay = ()=>{
			...
			var tabSwitcher = (()=>{
				...
				pricing.requestButton.forEach((button)=>{
